...
export default function SignUpScreen() {
  ...
  const handleSignUp = async () => {
    ...
    const { error, session: nextSession } = await signUp(email.trim(), password, fullName.trim());
    ...
    if (nextSession) {
      Alert.alert('Account created', 'Your account is ready. Taking you into Joinly now.');
      return;
    }

    Alert.alert(
      'Account created',
      'Your account was created successfully. If email confirmation is enabled, please verify your email, then sign in.'
    );
  };
          ...
          <View style={styles.content}>
            <View style={styles.heroCard}>
              ...
              <ThemedText style={styles.subtitle}>
                Set up your profile and start joining trusted activities.
              </ThemedText>
            </View>
